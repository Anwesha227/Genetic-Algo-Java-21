...
public class MnistStep1 {
    ...
    static Logger log = LoggerFactory.getLogger(MnistStep1.class);
    //The absolute path of the folder containing MNIST training and testing subfolders
    private static final String MNIST_DATASET_ROOT_FOLDER = "C:/Users/ANWESHA/Desktop/TCS Internship Details/GA/mnist_png";
